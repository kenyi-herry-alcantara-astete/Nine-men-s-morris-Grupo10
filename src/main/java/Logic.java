...
public class Logic {
    ...
    //Matriz recuerdo
    ArrayList<String> MemoryThreeInRow = new ArrayList<String>();

    public boolean isInTheMemory(String caseTresEnRaya){
        boolean res = false;

        for (String oneCase: MemoryThreeInRow){
    ...
    public void addToMemory(String caseTresEnRaya){
        MemoryThreeInRow.add(caseTresEnRaya);
    }

    public void removeFoTheMemory(String caseTresEnRaya){
        MemoryThreeInRow.remove(caseTresEnRaya);
    }
